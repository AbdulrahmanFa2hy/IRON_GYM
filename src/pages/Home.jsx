      ...
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-20 h-screen pt-0">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
            <div
              className={`max-w-3xl mt-16 sm:mt-0 transition-all duration-1000 transform ${
                isVisible
            ...
            >
              <div className="inline-block mb-3 bg-gradient-to-r from-[#DC2626] to-[#B91C1C] p-1 rounded-md">
                <h3 className="text-white text-xs sm:text-sm md:text-md font-['Cairo'] font-semibold uppercase tracking-widest px-3 py-1">
                  Transform Your Body
                </h3>
              </div>
              ...
              <p className="text-base sm:text-lg md:text-xl font-['Cairo'] text-[#D1D5DB] mb-8 max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/membership"
                  className="bg-gradient-to-r from-[#DC2626] to-[#B91C1C] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-md font-['Cairo'] font-bold transition duration-300 text-center flex items-center justify-center group hover:shadow-lg hover:shadow-[#DC2626]/20 transform hover:translate-y-[-2px]"
                >
                ...
                <Link
                  to="/#programs"
                  className="flex items-center justify-center text-white group font-['Cairo']"
                >
                ...
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className="flex items-center justify-center">
                      <div className="text-[#DC2626] text-xl sm:text-2xl md:text-5xl font-bold font-['Oswald']">
                        {stat.value.toLocaleString()}
                      </div>
                      <div className="text-[#DC2626] text-lg sm:text-xl md:text-3xl font-bold animate-pulse font-['Oswald']">
                        {stat.symbol}
                      </div>
                    </div>
                    <div className="text-white text-[10px] xs:text-xs md:text-sm mt-1 tracking-wider font-['Cairo'] uppercase">
                      {stat.label}
                    </div>
                  </div>
                ))}
      ...
      <div id="programs" className="py-12 sm:py-16 md:py-20 bg-[#111827]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-white mb-1 font-['Oswald']">
              OUR PROGRAM
            </h2>
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-[#DC2626] mb-4 sm:mb-8 font-['Oswald']">
              BUILD YOUR BEST BODY
            </h1>
            <p className="text-base sm:text-lg text-[#9CA3AF] max-w-3xl mx-auto font-['Cairo']">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-[#1F2937] rounded-lg overflow-hidden transform hover:scale-105 transition duration-300 shadow-xl">
              ...
              <div className="p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-bold text-[#DC2626] mb-2 font-['Oswald']">
                  FLEX MUSCLE
                </h3>
                <p className="text-sm sm:text-base text-[#9CA3AF] mb-4 sm:mb-6 font-['Cairo']">
                  Create a foundation of strength with our dynamic training
                  program focused on building muscle and functional strength.
                </p>
                <Link
                  to="/classes"
                  className="flex items-center text-white hover:text-[#DC2626] transition duration-300 font-['Cairo']"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="order-1 md:order-2">
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-white mb-2 font-['Oswald']">
              ...
              <div className="space-y-6 sm:space-y-8">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-[#9CA3AF] font-['Cairo']">
      ...
      <div className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-[#0F0F17] to-[#320D0D]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2 font-['Oswald']">
                CALCULATE
              </h2>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#DC2626] mb-4 sm:mb-6 font-['Oswald']">
                YOUR BMI
              </h1>
              <p className="text-sm sm:text-base text-[#9CA3AF] mb-6 sm:mb-8 font-['Cairo']">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 font-['Cairo']">
                <div>
              ...
              <Link
                to="/calculator"
                className="bg-[#DC2626] text-white px-6 sm:px-8 py-2 sm:py-3 rounded-md font-['Cairo'] font-bold hover:bg-[#B91C1C] transition duration-300 inline-flex items-center"
              >
      ...
      <div className="py-12 sm:py-16 md:py-20 bg-[#111827]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#DC2626] mb-4 sm:mb-8 font-['Oswald']">
              CLIENT FEEDBACK
            </h1>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              <div className="bg-[#1F2937] p-4 sm:p-6 md:p-8 rounded-lg relative shadow-xl">
                <div className="absolute -right-2 sm:-right-4 top-1/4 text-[#DC2626] text-6xl sm:text-9xl opacity-30 transform -translate-y-1/2 font-['Oswald']">
                  "
                </div>
                <p className="text-[#9CA3AF] text-sm sm:text-base md:text-lg mb-4 sm:mb-6 relative z-10 font-['Cairo']">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <h4 className="text-white text-base sm:text-lg md:text-xl font-medium font-['Oswald']">
                      ALEX MORGAN
                    </h4>
                    <p className="text-[#DC2626] text-sm font-['Cairo']">
                      Premium Member
                    </p>
                  </div>
                </div>
